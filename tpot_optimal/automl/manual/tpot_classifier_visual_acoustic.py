...
X_train,X_test,Y_train,Y_test=train_test_split(visual_and_acoustic,Y_labels,train_size=0.75,test_size=0.25)

tpot=TPOTClassifier(generations=40,population_size=25,verbosity=2,n_jobs=-1)
tpot.fit(X_train,Y_train)
print(tpot.score(X_test,Y_test))
tpot.export('suicide_40_25_visual_and_acoustic.py')
