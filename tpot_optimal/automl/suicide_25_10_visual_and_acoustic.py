...
# Average CV score on the training set was:0.728571428571
exported_pipeline = DecisionTreeClassifier(criterion="gini", max_depth=9, min_samples_leaf=17, min_samples_split=8)

exported_pipeline.fit(training_features, training_target)
results = exported_pipeline.predict(testing_features)

### Best pipeline: DecisionTreeClassifier(input_matrix, criterion=gini, max_depth=9, min_samples_leaf=17, min_samples_split=8)
### 0.6086956521739131
