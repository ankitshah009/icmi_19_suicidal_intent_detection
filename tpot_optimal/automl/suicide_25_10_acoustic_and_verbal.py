...
# Average CV score on the training set was:0.795238095238
exported_pipeline = GradientBoostingClassifier(learning_rate=0.5, max_depth=9, max_features=0.15, min_samples_leaf=8, min_samples_split=19, n_estimators=100, subsample=0.55)
