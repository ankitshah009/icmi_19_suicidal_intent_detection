...
# Average CV score on the training set was:0.714285714286
...
exported_pipeline = make_pipeline(
    ...
    Nystroem(gamma=0.1, kernel="cosine", n_components=5),
    GradientBoostingClassifier(learning_rate=0.5, max_depth=6, max_features=0.95, min_samples_leaf=16, min_samples_split=17, n_estimators=100, subsample=0.85)
)
