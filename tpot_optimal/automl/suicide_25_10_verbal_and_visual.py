...
exported_pipeline = make_pipeline(
    RFE(estimator=ExtraTreesClassifier(criterion="gini", max_features=0.05, n_estimators=100), step=0.7),
    RandomForestClassifier(bootstrap=False, criterion="gini", max_features=0.25, min_samples_leaf=6, min_samples_split=11, n_estimators=100)
)
...
#### Best pipeline: RandomForestClassifier(RFE(input_matrix, criterion=gini, max_features=0.05, n_estimators=100, step=0.7000000000000001), bootstrap=False, criterion=gini, max_features=0.25, min_samples_leaf=6, min_samples_split=11, n_estimators=100)
#### 0.5652173913043478
